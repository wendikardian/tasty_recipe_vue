<template>
    <div class="my-2 p-4 d-flex flex-column-reverse flex-lg-row justify-content-between border border-secondary-sublet rounded">
      <div class="pe-lg-4">
        ...
        <p>
          this dish is so common and iconic among Koreans that we simply call it
          “kimchi.” When people talk about kimchi, this is the side dish they’re
          referring to, despite the fact that there are many kinds of kimchi in
          Korean cuisine, and many made with napa cabbage, too.
        </p>
      ...
      <div class="ps-lg-4">
        <img src="" alt="Food" class="recipe__detail-img rounded mx-auto" style="object-fit: cover"/>
      </div>
    </div>
  </template>
